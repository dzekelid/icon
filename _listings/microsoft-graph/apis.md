...
- name: Microsoft Graph API Get Icon
  ...
  - type: x-postman-collection
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/icon/master/_listings/microsoft-graph/workbook-tables(-lt;id|name-gt;)-sort-fields-icon-get-postman.md
x-common:
- type: x-change-loge
